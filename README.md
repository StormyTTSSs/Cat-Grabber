...
```d
 Here put your Discord Webhook you can find it in your 
...
```d
: Here put your final file name like "blackcap_is_best" or "KSCH_the_Goat" 🤓
```
...
```d
 This is a option to "KILL" all process which could analyze the properties of blackcap, 
...
```d
 This is a option to ping when someone run BlackCap you can specify "everyone" or "here"
```
...
```d
 If you chose 'yes' to the previous option you will have to fill in this with 
...
```d
 This option allows you to display an error message when someone launches your blackcap 
...
```d
 This option will close automatically the window that will launch blackcap 
...
```d
 This option will obfuscate the source code 
I recommand to chose 'yes'
```
![](https://media.discordapp.net/attachments/912038729626058853/1062474365079388201/image.png)
```d
 This option will create an .exe if you put 'no' the final file will be an .py
```
